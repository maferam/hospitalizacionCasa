    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=45, verbose_name='Nombre')),
                ('id_paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='acudiente', to='authApp.paciente')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='acudiente', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
